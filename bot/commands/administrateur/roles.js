 ...
 module.exports = (client, message, args) => {
  ...
  if (!role) {
    ...
    client.channels.cache.get("671235889741037597").send(`Le rôle "${args[0]}" n'exite pas !`);
    client.channels.cache.get("626410317798309912").send(`Le rôle "${args[0]}" n'exite pas !`);
    return;
  }
